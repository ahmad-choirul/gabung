				...
				<div class="row">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<?php 
							$sql = "SELECT idtugas,judul, isi, deadline FROM tugas where iduser = " . $_SESSION["id_user"] . " and  (deadline>=CURRENT_DATE) order by deadline desc;";
						...
						<div class="row">
							<?php 
							$sql = "SELECT judul, isi, deadline FROM tugas where iduser = " . $_SESSION["id_user"] . " and  (deadline<CURRENT_DATE )order by deadline desc;";
							$result = mysqli_query($db_link, $sql);
