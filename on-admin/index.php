				...
				<div class="col-md-4 col-sm-4">
					<div class="panel panel-danger">
						<div class="panel-heading" style="background-color: #c90000; color: white">
							<div class="fa fa-exclamation-triangle" aria-hidden="true" > TUGAS </div>
						</div>
						<div class="panel-body">
							<p>ini isi dari tugas yang di inputkan oleh user dan menampilkan tugas yang paling dekat dengantamggal sekarang</p>
						</div>
						<div class="panel-footer">
							deadline : tanggal dari database
						</div>
					</div>
				</div>
				<!-- /. WRAPPER  -->
