        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="tambah_user.php"><i class="fa fa-edit fa-3x"></i> pengguna </a>
                    </li>
                    <li>
                        <a href="admin_peserta.php"><i class="fa fa-users fa-3x"></i> Peserta </a>
                    </li>
                    <li>
        ...
        <div class="panel panel-default">
         ...
         <div class="table-responsive">
             <table class="table table-striped table-bordered table-hover" >
                <thead>
                  <tr >
                    ...
                    <td style="width: 100px; background-color: skyblue"th>Nama</td>
                    <td style="width: 200px; background-color: skyblue"th>NIM</td>
                    <td style="width: 200px; background-color: skyblue"th>Password</td>
                    <td style="width: 20px; background-color: skyblue"th>Level</td>
            ...
            <tbody>
              ...
              $no = 1;
              $sql = mysqli_query($db_link,"select * from users;");
              while ($data = mysqli_fetch_array($sql)){
                ...
                <tr>
                  ...
                  <td>
                    <a href="edit_kelas.php?id_user=<?php echo $data['id_user']; ?>" class='btn btn-warning ' ><span class="glyphicon glyphicon-pencil"></span></a>

                    <a href="proses delete.php?id_user=<?php echo $data['id_user'];?>" onclick="return confirm('Yakin mau di hapus?');" class='btn btn-danger '><span class="glyphicon glyphicon-trash"></span></a>
                </td>
            </tr>
            <?php
            $no++;
